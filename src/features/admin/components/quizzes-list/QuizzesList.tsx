...
import { useDeleteQuiz } from "@/features/admin/api/use-delete-quiz";
...
import type { QuizzesListProps } from "@/features/admin/components/quizzes-list/quizzes-list.types";
